...
#define DUNE_IMC_CONST_GIT_INFO "2015-05-12 b290938  (HEAD, origin/noptilus/grammar, noptilus/grammar)"
//! MD5 sum of XML specification file.
#define DUNE_IMC_CONST_MD5 "4631fbae2e9f14ef8e52f3a1d74d2813"
