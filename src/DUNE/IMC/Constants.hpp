...
#define DUNE_IMC_CONST_GIT_INFO "2015-02-27 698845b  (HEAD, origin/feature/followref_uav, origin/HEAD, feature/followref_uav)"
//! MD5 sum of XML specification file.
#define DUNE_IMC_CONST_MD5 "f6f5adb5d6ef31881d40b0811697f34f"
